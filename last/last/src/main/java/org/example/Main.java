...
public class Main {
    public static void main(String[] args) {
        ...
        MesaDeAyuda mesadeayuda = new MesaDeAyuda("Soluciones TI SA");


        /// Se procede a instanciar a los usuarios que han registrado incidenctes
        ///Excepción: se deberá registrar la u al inicio de cada código de usuario
        ...
        try {
            usu1 = new Usuario("u202316328", "Daniel", "Gerente", "AE");
            usu2 = new Usuario("u202316327", "Pedro", "Practicante", "AI");
            usu3 = new Usuario("u202316326", "Paolo", "Supervisor", "AI");
            usu4 = new Usuario("u202316325", "Jeferson", "Gerente", "AI");
        ...
        /// Instanciar a los responsables asignados a los incidentes reportados.

        Responsable resp1 = new Responsable("R01", "Pedro", "Tecnico1");
        Responsable resp2 = new Responsable("R02", "Juan", "Tecnico2");


        ///Instanciar a las categoria de los tipos de incidentes que pueden ocurrir
        ...
        ////instanciar los incidentes respotados por los usuarios
        ...
        Incidencia inc3 = new Incidencia("I003", cat3, "04/01/2023", "No Iniciado", usu3, resp1);
        Incidencia inc4 = new Incidencia("I004", cat4, "04/01/2023", "En proceso", usu4, resp1);
        ...
        Incidencia inc10 = new Incidencia("I010", cat2, "05/01/2023", "Cerrado", usu6, resp2);
        Incidencia inc11 = new Incidencia("I011", cat3, "05/01/2023", "Cerrado", usu2, resp2);
        Incidencia inc12 = new Incidencia("I012", cat3, "05/01/2023", "Cerrado", usu6, resp2);
        Incidencia inc13 = new Incidencia("I013", cat1, "05/01/2023", "Cerrado", usu10, resp2);
        Incidencia inc14 = new Incidencia("I014", cat1, "05/01/2023", "Cerrado", usu10, resp1);
        Incidencia inc15 = new Incidencia("I015", cat2, "05/01/2023", "Cerrado", usu2, resp1);
        Incidencia inc16 = new Incidencia("I016", cat2, "05/01/2023", "En proceso", usu8, resp1);
        Incidencia inc17 = new Incidencia("I017", cat3, "05/01/2023", "En proceso", usu2, resp1);
        Incidencia inc18 = new Incidencia("I018", cat1, "06/01/2023", "No Iniciado", usu7, resp1);
        Incidencia inc19 = new Incidencia("I019", cat1, "06/01/2023", "No Iniciado", usu2, resp1);
        Incidencia inc20 = new Incidencia("I020", cat2, "06/01/2023", "No Iniciado", usu9, resp2);


        ///Agregar las incidencia en la clase mesa de ayuda
        ...
        ///Mostrar las incidencias y sus atributos
        ...
        ///Lsitamos las incidencias reportadas
        ...
        /// Generamos un método que reporte el porcentaje de las incieencias según su estado
        ...
        ///Generamos un método para obtener el tipo de inicidencia con mayor recurrencia reportada

        System.out.println("------------Tipo de incidencia con mayor recurrencia reportada ------------");
        ...
        ///Generamos un método para obtener el área que ha reportado más incidencias

        System.out.println("------------Área con mayor cantidad de incidencias reportadas------------");
        ...
        for (Incidencia incidencia : listaIncidencia) {
            ...
            String area = incidencia.getUsuario().getArea();
